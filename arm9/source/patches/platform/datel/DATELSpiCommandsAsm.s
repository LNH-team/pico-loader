...
@void DATEL_EnableSpi();
BEGIN_ASM_FUNC DATEL_EnableSpi
    push {r0-r3,lr}
    ldr r1, =REG_MCCNT0
    @ Use 0x1FBF here
    ldr r3, =#0xA0401FBF
...
BEGIN_ASM_FUNC DATEL_CycleSpi
    push {r0-r3, lr}
    movs r0, DATEL_CMD_F2_SPI_DISABLE
    bl DATEL_SendNtrCommandF2
    bl DATEL_EnableSpi
    ldr r1, DATEL_CycleSpi_ReadSpiByte
    bl DATEL_CycleSpi_Interwork
    movs r0, DATEL_CMD_F2_SPI_ENABLE
    bl DATEL_SendNtrCommandF2
    bl DATEL_EnableSpi
    pop {r0-r3, pc}
DATEL_CycleSpi_Interwork:
    bx r1
.balign 4
.pool
.global DATEL_CycleSpi_ReadSpiByte
DATEL_CycleSpi_ReadSpiByte:
    .word 0
